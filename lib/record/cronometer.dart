...
import 'package:projeto_app/record/alarm.dart';
import 'package:projeto_app/record/background_cronometer.dart';
...
//  the reference to it is constant but the Name string is mutable. In short: this is a workaround to allow the Cronometer's name to be modifiable.
